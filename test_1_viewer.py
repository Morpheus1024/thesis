...
def test_1_viewer():
    ...
    try:
        while True:
            ...
            # Add a circle at the center of the color_image
            center_coordinates = (color_image.shape[1] // 2, color_image.shape[0] // 2)
            radius = 5
            color = (0, 255, 0)  # Green color in BGR
            thickness = 2
            cv2.circle(color_image, center_coordinates, radius, color, thickness)
